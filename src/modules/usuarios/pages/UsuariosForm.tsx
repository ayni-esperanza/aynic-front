            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  className="px-2 py-1 text-sm border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"
                >
                  Volver
                </Button>
              ...
              <Button
                ...
                className="px-3 py-1 text-sm bg-gradient-to-r from-[#18D043] to-[#16a34a] hover:from-[#16a34a] hover:to-[#15803d]"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-3 gap-y-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute text-gray-400 dark:text-gray-500 transition-colors duration-200 right-3 top-7 hover:text-gray-600 dark:hover:text-gray-300"
                  disabled={isSubmitting}
                >
