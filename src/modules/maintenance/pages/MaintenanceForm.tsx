        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Card>
              ...
              {selectedRecord && (
                <div className="p-4 mt-4 sm:mt-6 border border-indigo-200 rounded-lg bg-gradient-to-r from-indigo-50 to-blue-50">
                  <h3 className="flex items-center mb-3 text-sm sm:text-base font-semibold text-indigo-900">
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-indigo-900">{selectedRecord.cliente}</p>
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-indigo-700">
                        Longitud Actual
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200 resize-none ${errors.description
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-yellow-700">
                              ...
                              <span
                                className={`font-semibold ${formData.new_length_meters >
            ...
            <Card>
              ...
              <div className="space-y-4">
                {!selectedFile ? (
                  <div className="p-4 sm:p-8 text-center transition-colors border-2 border-gray-300 border-dashed cursor-pointer rounded-xl hover:border-indigo-400 group">
                    <Upload className="w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 text-gray-400 transition-colors group-hover:text-indigo-500" />
                    <h3 className="mb-2 text-base sm:text-lg font-medium text-gray-900">
                      Subir imagen del mantenimiento
                    </h3>
                    <p className="max-w-sm mx-auto mb-3 sm:mb-4 text-sm sm:text-base text-gray-600">
                  ...
                  <div className="p-3 sm:p-4 border border-gray-200 bg-gray-50 rounded-xl">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      <div className="flex-shrink-0">
                        <img
                          src={filePreview!}
                          alt="Preview del mantenimiento"
                          className="object-cover w-16 h-16 sm:w-24 sm:h-24 border border-gray-300 rounded-lg shadow-sm"
                        />
                      </div>
              ...
              formData.new_length_meters !== selectedRecord.longitud && (
                <Card className="bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200">
                  <div className="flex items-start space-x-3">
                    <div className="flex-shrink-0">
                      <div className="flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-amber-100">
                        <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600" />
                      </div>
                    </div>
                    <div className="flex-1">
                      <h3 className="mb-2 text-base sm:text-lg font-semibold text-amber-900">
                        Confirmación de Cambio de Longitud
                      </h3>
                      <p className="mb-4 text-sm sm:text-base text-amber-800">
                        Estás registrando un cambio en la longitud de la línea de
                        vida. Este cambio se guardará permanentemente en el
                        historial.
                      </p>

                      <div className="grid grid-cols-1 gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg sm:grid-cols-3 bg-white/70">
                        ...
                        <div className="text-center">
                          ...
                          <p
                            className={`text-lg sm:text-2xl font-bold ${formData.new_length_meters > selectedRecord.longitud
                                ? "text-green-600"
                                : "text-red-600"
                              }`}
                          >
            ...
            {/* Botones de acción */}
            <div className="sticky bottom-0 px-3 sm:px-6 pt-4 sm:pt-6 pb-4 sm:pb-6 -mx-3 sm:-mx-6 -mb-3 sm:-mb-6 bg-white border-t border-gray-200 rounded-t-lg shadow-lg">
