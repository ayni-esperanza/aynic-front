...
class AccidentService {
  ...
  private mapBackendToFrontend(backendAccident: BackendAccident): Accident {
    return {
      ...
      linea_vida_codigo: backendAccident.linea_vida_codigo,
      linea_vida_cliente: backendAccident.linea_vida_cliente,
      linea_vida_ubicacion: backendAccident.linea_vida_ubicacion,
      fecha_accidente: backendAccident.fecha_accidente,
      descripcion: backendAccident.descripcion,
      ...
      lesiones: backendAccident.lesiones,
      testigos: backendAccident.testigos,
      medidas_correctivas: backendAccident.medidas_correctivas,
      fecha_investigacion: backendAccident.fecha_investigacion,
      investigador: backendAccident.investigador,
      conclusiones: backendAccident.conclusiones,
      created_at: backendAccident.created_at,
      updated_at: backendAccident.updated_at,
    };
  }
